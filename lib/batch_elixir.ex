defmodule BatchElixir do
  ...
  def send_notication(device, group_id, custom_ids, title, message, nil, custom_payload, labels, gcm_collapse_key_enabled) do
    send_notication(
      device,
      group_id,
      custom_ids,
  ...
  def send_notication(device, group_id, custom_ids, title, message, deeplink, nil, labels, gcm_collapse_key_enabled) do
    structure = create_transactional_structure(group_id, custom_ids, title, message, deeplink, labels, gcm_collapse_key_enabled)
    do_send_notication(device, structure)
  end

  def send_notication(device, group_id, custom_ids, title, message, deeplink, custom_payload, labels, gcm_collapse_key_enabled)
    ...
    send_notication(device, group_id, custom_ids, title, message, deeplink, custom_payload, labels, gcm_collapse_key_enabled)
  end
  ...
  defp create_transactional_structure(group_id, custom_ids, title, message, deeplink, labels,gcm_collapse_key_enabled) do
